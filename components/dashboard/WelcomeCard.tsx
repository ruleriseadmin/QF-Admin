...
const WelcomeCard: React.FC<WelcomeCardProps> = ({ stats }) => {
  ...
  const fetchLoans = async (filter: any, type: string) => {
    try {
      setLoading(true);
      const startDate = type === 'customers' ? searchDate.startDate : type === 'disbursed' ? disbursedSearchDate.startDate : collectedSearchDate.startDate;
      const endDate = type === 'customers' ? searchDate.endDate : type === 'disbursed' ? disbursedSearchDate.endDate : collectedSearchDate.endDate;
  ...
  return (
    <div className="mt-12 h-auto font-montserrat ml-4 lg:ml-8 md:ml-11 mr-2">
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-3 grid-cols-1 lg:gap-5 md:gap-2 gap-5 mt-6">
          ...
          <div className="md:ml-4 lg:mx-4 mx-4 mt-4">
            <div className="flex justify-between items-center">
              <div className='flex justify-start items-center'>
                <p className="text-[#ffffff] text-[18px] font-medium">Unique Customers</p>
        ...
        <div className="w-full min-h-[207px] h-auto bg-[#282828] shadow-custom2 rounded-[8px]">
          <div className="md:ml-4 lg:mx-4 mx-4 mt-4">
            <div className="flex justify-between items-center">
              <div className='flex justify-start items-center'>
                <p className="text-[#ffffff] text-[18px] font-medium">Total Principal Disbursed</p>
              <IoIosInformationCircleOutline className="text-lg text-[#C3C3C3] ml-1" />
              </div>
        ...
        <div className="w-full min-h-[207px] h-auto bg-[#282828] shadow-custom2 rounded-[8px]">
          <div className="md:ml-4 lg:mx-4 mx-4 mt-4">
            <div className="flex justify-between items-center">
              <div className="flex justify-start items-center ">
                 <p className="text-[#ffffff] text-[18px] font-medium">Total Collected <span className='text-[10px]'>(principal+interest+penalty)</span></p>
